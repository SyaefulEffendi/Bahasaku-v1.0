...
class FeedbackSchema(Schema):
    """Schema untuk validasi feedback.
    
    CATATAN: Marshmallow tidak menggunakan 'default' untuk nilai default database.
    Nilai default database (Baru) sudah diatur di feedback_model.py.
    """
